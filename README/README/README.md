...
### [👉 개발 컨벤션 링크](codeConvention.md)

## Emotion 가이드

### [👉 Emotion 가이드 링크](Emotion.md)
...
![비지니스 캔버스](../image/bc.png)

### 2. Userflow

![유저 플로우](../image/userFlow.png)
...
- 아래 디자인으로 상세 페이지 만들고 옆으로(carousel) 넘기면 벽과 액자에 애니메이션을 줘서 옆으로 넘어가고 슥슥 넘기면서 1인칭 시점으로 전시회에서 다음 작품으로 넘어가는 것처럼 보이게
  ...
  ![상세 페이지 래퍼런스](../image/detailReper.png)
...
|                                                 **김대유**                                                 |                                            **김민석**                                            |                                                **박민서**                                                |                                                **유호준**                                                 |
| :--------------------------------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------: | :-------------------------------------------------------------------------------------------------------: |
| [<img src="../image/김대유.jpeg" height=150 width=150> <br/> @Mushroombud](https://github.com/Mushroombud) | [<img src="../image/김민석.jpeg" height=150 width=150> <br/> @minss7](https://github.com/minss7) | [<img src="../image/박민서.jpeg" height=150 width=150> <br/> @charijyard](https://github.com/charijyard) | [<img src="../image/유호준.png" height=150 width=150> <br/> @hoooooojjjj](https://github.com/hoooooojjjj) |
