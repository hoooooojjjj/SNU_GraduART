        ...
        <FooterContainer>
            ...
            <FooterContent>
                ...
                <Column>
                    ...
                    <Text>문의 이메일</Text>
                    <Text>
                        <NavLink to="mailto:snugraduart@naver.com">snugraduart@naver.com</NavLink>
                    </Text>
                </Column>
                <Column>
                    <Title>운영정책</Title>
                ...
                <Column>
                    <Title>Made by</Title>
                    <img width={`20%`} src={`${import.meta.env.VITE_PUBLIC_URL}/assets/likeLion.png`} alt="LikeLion Logo" />
                    <Title>Join Us</Title>
                    <NavLink to="https://facebook.com">Facebook</NavLink>
                    <NavLink to="https://instagram.com">Instagram</NavLink>
                </Column>
            </FooterContent>
            <Text css={css`text-align: center; margin-top: 20px;`}>SNUgraduART @ 2024. All rights reserved.</Text>
        </FooterContainer>
    );
};
